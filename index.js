...
function Mailgen(options) {
  ...
  this.themeName =
    typeof this.theme === "string" && this.theme ? this.theme : "default";
...
Mailgen.prototype.cacheThemes = function () {
  ...
  var themePath =
    typeof this.theme === "object" && this.theme.path
      ? this.theme.path
      : __dirname + "/themes/" + this.themeName + "/index.html";
  ...
  var plaintextPath =
    typeof this.theme === "object" && this.theme.plaintextPath
      ? this.theme.plaintextPath
      : __dirname + "/themes/" + this.themeName + "/index.txt";
...
Mailgen.prototype.parseParams = function (params) {
  ...
  if (!params || typeof params !== "object") {
    throw new Error(
      "Please provide parameters for generating transactional e-mails."
    );
  }
  ...
  if (body.greeting !== false) {
    ...
    if (!body.title) {
      ...
      body.title =
        (body.name ? body.greeting + " " + body.name : body.greeting) + ",";
    }
  }
